...
<html>
	...
	* date * 09-11-2015
	*/
	include_once 'includes/layout/HeadBarRules.php'; ?>
	<body>
		<div id="page-wrapper">
			<!-- Navigation Bar -->
			...
			<?php
				/*
				* Add guide user & manager by : bryan.maisano@gmail.com
				* date * 09-11-2015
				*/
				if ($_SESSION['role'] == 'Admin' || $_SESSION['role'] == 'Manager' || $_SESSION['role'] == 'Player') : ?>
				<div class="wb-tabs ignore-session"  style="background-color:white;border-width:1px;border-style:dotted;border-color:black;" >
					<div class="container">
						<ul class="tabs">
											...
											<div id="content">
												<!-- Content -->
													<article>
														...
														<span class="image featured" style="max-width: 20%; max-height: 20%;" ><img src="images/NewGame.JPG" alt="" /></span>
														<p>
														...
														<span class="image featured" style="max-width: 50%; max-height: 50%; align=middle;" ><img src="images/NewGameP.JPG" alt="" /></span>
														...
														<span class="image featured"><img src="images/ListeBoxA.JPG" style="max-width: 50%; max-height: 50%; align=middle;" alt="" /></span>
														<p>Figure 3: Add user in game</p>
														<p>
															<li>Select player in table «  Player out game »,</li>
															<li>Click in the left button for add.</li>
														</p>
														<span class="image featured"><img src="images/ADD.JPG" style="max-width: 20%; max-height: 20%; align=middle;" alt="" /></span>
														<p>Add player in game:</p>
														<span class="image featured"><img src="images/ListeBoxD.JPG" style="max-width: 50%; max-height: 50%; align=middle;" alt="" /></span>
														<p>Figure 4: Delete user of game</p>
														<p>
															<li>Select player in table «  Player in game »,</li>
															<li>Click in the right button for delete.</li>
														</p>
														<span class="image featured"><img src="images/DEL.JPG" style="max-width: 20%; max-height: 20%; align=middle;" alt="" /></span>
														...
														<span class="image featured"><img src="images/ShowGame.JPG" style="max-width: 20%; max-height: 20%; align=middle;" alt="" /></span>
														...
														<h1 id="mlien121">1.2.1 Add plant</h1>
															...
															<span class="image featured"><img src="images/AddNewPlant.JPG" style="max-width: 50%; max-height: 50%; align=middle;" alt="" /></span>
														...
														<span class="image featured"><img src="images/AddTypePlantManage.JPG" style="max-width: 50%; max-height: 50%; align=middle;" alt="" /></span>
